...
//  private List data; // save where the player place the chess piece.
  ...
  public AutoChessGame(GameManager gameManager) {
    ...
    NPC1_ChessPiece.add(new StarChessPiece(gameManager.getScreen_width()*0.6f,gameManager.getScreen_height()*0.4f, this));
    NPC1_ChessPiece.add(new TriangleChessPiece(gameManager.getScreen_width()*0.6f,gameManager.getScreen_height()*0.65f, this));
//    NPC1_ChessPiece.add(new StarChessPiece(1, 2));
    NPC2_ChessPiece.add(new StarChessPiece(gameManager.getScreen_width()*0.6f,gameManager.getScreen_height()*0.4f, this));
    NPC2_ChessPiece.add(new TriangleChessPiece(gameManager.getScreen_width()*0.6f,gameManager.getScreen_height()*0.65f, this));
...
//        } else {
//          boolean r3 = NPC1_ChessPiece.get(0).getPower() <= ((ChessPiece) chess).getPower();
//          battle_result.add(r3);
//        }
      }
...
//        } else {
//          boolean r3 = NPC2_ChessPiece.get(0).getPower() <= ((ChessPiece) chess).getPower();
//          battle_result.add(r3);
//        }
      }
