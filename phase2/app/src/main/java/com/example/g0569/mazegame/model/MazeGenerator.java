...
public class MazeGenerator {
  ...
  /**
   * helper method of generate method randomly place represented NPC of assigned number into
   * mazeGrid
   *
  ...
  /**
   * helper method of generate method Check whether the node is valid to be assigned as a path.
   *
